...
- elastic_net | G3_plus_shuffled_sentiment | lag=0 | epochs=300 | patience=20: rmse=0.046427, mae=0.032983, dir_acc=0.5169, sharpe=0.2304
- ridge | G3_plus_lagged_sentiment | lag=0 | epochs=300 | patience=20: rmse=0.046457, mae=0.033016, dir_acc=0.5114, sharpe=0.1689
- ridge | G3_plus_shuffled_sentiment | lag=0 | epochs=300 | patience=20: rmse=0.046458, mae=0.033014, dir_acc=0.5133, sharpe=0.2003
...
- hist_gbr | G3_plus_shuffled_sentiment | lag=0 | epochs=150 | patience=20: rmse=0.046787, mae=0.033204, dir_acc=0.5102, sharpe=-0.0204
...
- Model_C_sentiment_only: rmse=0.046426, mae=0.033000, dir_acc=0.5200, sharpe=0.3106, family=elastic_net, lag=0, epochs=300, patience=20, n_features=12
- Model_D_price_shuffled_sentiment: rmse=0.046427, mae=0.032983, dir_acc=0.5169, sharpe=0.2304, family=elastic_net, lag=0, epochs=300, patience=20, n_features=34
- Model_E_price_lagged_sentiment: rmse=0.046424, mae=0.032982, dir_acc=0.5167, sharpe=0.2354, family=elastic_net, lag=0, epochs=300, patience=20, n_features=34
