...
- elastic_net | G3_plus_shuffled_sentiment | lag=0 | epochs=300 | patience=20: rmse=0.020377, mae=0.014003, dir_acc=0.5122, sharpe=0.2031
...
- ridge | G3_plus_shuffled_sentiment | lag=0 | epochs=300 | patience=20: rmse=0.020387, mae=0.014011, dir_acc=0.5115, sharpe=0.2200
...
- hist_gbr | G3_plus_shuffled_sentiment | lag=0 | epochs=120 | patience=20: rmse=0.020466, mae=0.014027, dir_acc=0.5085, sharpe=-0.1395
...
- Model_C_sentiment_only: rmse=0.020388, mae=0.014010, dir_acc=0.5125, sharpe=0.1418, family=elastic_net, lag=0, epochs=300, patience=20, n_features=12
- Model_D_price_shuffled_sentiment: rmse=0.020377, mae=0.014003, dir_acc=0.5122, sharpe=0.2031, family=elastic_net, lag=0, epochs=300, patience=20, n_features=34
- Model_E_price_lagged_sentiment: rmse=0.020368, mae=0.014012, dir_acc=0.5049, sharpe=-0.1005, family=hist_gbr, lag=0, epochs=120, patience=20, n_features=34
